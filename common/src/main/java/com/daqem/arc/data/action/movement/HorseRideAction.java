...
public class HorseRideAction extends AbstractAction {
    ...
    public static class Serializer implements IActionSerializer<HorseRideAction> {
        ...
        @Override
        public HorseRideAction fromNetwork(ResourceLocation location, FriendlyByteBuf friendlyByteBuf, ResourceLocation actionHolderLocation, IActionHolderType<?> actionHolderType, boolean performOnClient, List<IReward> rewards, List<ICondition> conditions) {
            return new HorseRideAction(location, actionHolderLocation, actionHolderType, performOnClient, rewards, conditions);
        }

        @Override
        public void toNetwork(FriendlyByteBuf friendlyByteBuf, HorseRideAction type) {
